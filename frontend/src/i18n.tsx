...
'nav.apikeys': 'API Keys',
  ...
  vi: {
    'app.title': 'Trình quản lý XproxyT',
    ...
    'dashboard.configuredProviders': 'Nhà cung cấp đã cấu hình',
    ...
    'providers.select': 'Chọn nhà cung cấp để cấu hình',
    ...
    'providers.save': 'Lưu nhà cung cấp',
