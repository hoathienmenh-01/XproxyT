  ...
  return (
    <section aria-labelledby="settings-title" className="page-panel settings-panel">
      ...
      <div className="surface-card">
        ...
        <div className="settings-grid">
          <label className="field">
            ...
            <p className="field-hint" style={{marginTop: 4, fontSize: '0.85em', color: 'var(--text-4)'}}>
      ...
      <div className="surface-card">
        ...
        {egressEnabled && (
          <p style={{marginTop: 8, fontSize: '0.85em', padding: '8px 12px', background: 'var(--warn-soft)', borderRadius: 'var(--r-sm)', border: '1px solid rgba(251,191,36,0.15)', color: 'var(--warn)'}}>
      ...
      {message ? <div className="inline-message ok" style={{marginTop: 'var(--sp-3)'}}>{message}</div> : null}
    </section>
  );
}
